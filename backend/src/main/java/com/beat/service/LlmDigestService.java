...
public class LlmDigestService {
     ...
     */
    public List<RawArticle> clusterAndRank(List<RawArticle> candidates, String topicQuery, int targetCount) {
        ...
        String systemPrompt = """
                ...
                2. Rank the top unique articles by relevance, recency, and source diversity up to the target count.
     ...
     */
    public void synthesizeBlurbs(List<RawArticle> rankedArticles, String topicQuery) {
