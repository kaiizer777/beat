...
public class TinyFishFetchClient {
    ...
    public TinyFishFetchClient(@Value("${TINYFISH_API_KEY:}") String apiKey) {
    ...
    private FetchResult tryTinyFishFetch(String url) {
        ...
        try {
            ...
            log.warn("TinyFish Fetch error for {}: {}", url, e.getMessage());
        }
        return null;
    }
    ...
    private FetchResult tryJinaFetch(String url) {
        try {
            ...
            log.warn("Jina AI Reader error for {}: {}", url, e.getMessage());
        }
        return null;
    }
